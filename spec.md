...
### 7.2 Hugo Configuration (hugo.yaml)
...
- [ ] YouTube embeds are displayed
- [ ] .mov video plays
- [ ] About page renders with text and image
- [ ] Photo Gallery page shows gallery grid
- [ ] Random Videos page shows all embedded videos
- [ ] Sidebar shows Menu, Categories, Archives, Stuff
- [ ] Category links filter to correct posts
- [ ] Archive links filter to correct posts
- [ ] Comments display on posts that have them
- [ ] Lightbox effect works on images
- [ ] Header looks identical (background image, title, tagline)
- [ ] Footer renders with correct text and styling
- [ ] No broken image links
- [ ] No external requests to rowanemilia.com or WordPress domain
- [ ] Mobile/responsive layout is acceptable (original was 800px fixed width)
